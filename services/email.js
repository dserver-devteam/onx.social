...
const emailTemplates = {
    welcome: (username) => ({
        ...
        html: `
            ...
            <body>
                <div class="container">
                    <div class="header">
                        <div class="logo">realtalk.now</div>
                    </div>
                    <div class="content">
                        <h1>Welcome to RealTalk, ${username}! 🎉</h1>
                        <p>We're excited to have you join our community!</p>
                        <p>RealTalk is a modern social platform where you can:</p>
                        <ul>
                        ...
                        <a href="http://localhost:3000" class="button">Go to RealTalk</a>
                    </div>
                    <div class="footer">
                        <p>This email was sent from RealTalk</p>
                        <p>© 2025 RealTalk. All rights reserved.</p>
                    </div>
                </div>
            </body>
            </html>
        `,
        text: `Welcome to RealTalk, ${username}! We're excited to have you join our community. Start exploring and make your first post today!`
    }),

    newFollower: (followerName, username) => ({
        subject: `${followerName} started following you on RealTalk`,
        html: `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                <div class="container">
                    <div class="content">
                        <h1>New Follower! 🎉</h1>
                        <p>Hi ${username},</p>
                        <p><strong>${followerName}</strong> started following you on RealTalk!</p>
        ...
        `,
        text: `${followerName} started following you on RealTalk!`
    }),
    ...
    account_deleted: (username) => ({
        subject: 'Your RealTalk Account Has Been Deleted',
        html: `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Hi ${username},</p>
                        <p>Your RealTalk account has been permanently deleted by an administrator.</p>
                        <div class="warning">
                        ...
                        <p>Thank you for being part of RealTalk.</p>
                    </div>
                    <div class="footer">
                        <p>This email was sent from RealTalk</p>
                        <p>© 2025 RealTalk. All rights reserved.</p>
        ...
        `,
        text: `Hi ${username}, Your RealTalk account has been permanently deleted. All your data has been removed from our system. If you believe this was done in error, please contact support.`
    }),

    email_verification: (username, token) => ({
        subject: 'Verify your RealTalk email address',
        html: `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Hi ${username},</p>
                        <p>Thanks for signing up for RealTalk! Please verify your email address to complete your registration.</p>
        ...
        `,
        text: `Hi ${username}, Thanks for signing up for RealTalk! Please verify your email address by visiting: http://localhost:3000/verify-email.html?token=${token}`
    }),

    password_reset: (username, token) => ({
        subject: 'Reset your RealTalk password',
        html: `
            <!DOCTYPE html>
            <html>
            <head>
...
async function sendEmail(to, template, ...args) {
    try {
        ...
        const mailOptions = {
            from: `"RealTalk" <${process.env.EMAIL_FROM || 'noreply@dserver-team.com'}>`,
            to: to,
